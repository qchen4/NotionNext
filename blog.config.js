...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '24248e57eb3780418f69eeb81ab42f10,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo-nord', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jeremy Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'FPGA Engineer, Cloud Solution Engineer, Georgia Tech MS', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-wine-sigma-35.vercel.app/', // 网站地址
